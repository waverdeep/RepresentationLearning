...
configuration = {
    ...
    # model
    "pretext_model_name": "WaveBYOLLight",
    "encoder_input_dim": 1,
    "encoder_hidden_dim": 512,
    "encoder_filter_size": [10, 8, 4, 4, 4, 4, 4, 4, 4, 4],
    "encoder_stride": [5, 4, 2, 2, 2, 2, 2, 2, 2, 2],
    "encoder_padding": [2, 2, 2, 2, 2, 2, 2, 2, 2, 1],
    "mlp_input_dim": 512,
    "mlp_hidden_dim": 4096,
    "mlp_output_dim": 4096,
    "ema_decay": 0.89,
