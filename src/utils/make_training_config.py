...
configuration_speaker_classification = {
    ...
    "dataset": {
        "train_dataset": "./dataset/train-list-librispeech.txt",
        "train_speaker_list": "./dataset/train-speaker-list-librispeech.txt",
        "validation_dataset": "./dataset/dev-list-librispeech.txt",
        "validation_speaker_list": "./dataset/dev-speaker-list-librispeech.txt",
        "num_workers": 8,
    },
    "model": {
        "batch_size": 3,
    ...
    "pretext_model": {
        ...
        "g_ar_hidden": 256,
        "g_enc_input": 1,
        "load_checkpoint": './checkpoint/direct_train10-model_best.pt',
    },
    "downstream_model": {
        "epoch": 100,
        "speaker_num": 251,
